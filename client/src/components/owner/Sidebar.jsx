...
{
    image && (
        <button onClick={updateImage} className='absolute top-0 right-0 p-2 gap-1 bg-primary/10 text-primary cursor-pointer'>
...
>
  ...
  <div
    ...
    } h-5 w-1.5 rounded-r-full right-0 absolute`}
  ></div>
</NavLink>
